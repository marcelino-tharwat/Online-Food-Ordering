...
function MainLayout() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-white selection:bg-primary/15 selection:text-primary">
      <Navbar />
      ...
      <footer className="border-t border-border-light bg-accent/30">
